...
public class PieChartUtil {
    ...
    private void setPieChartData(PieChart pieChart, Map<String, Float> pieValues) {
        ...
        legend.setFormToTextSpace(0f);               //设置每个图例实体中标签和形状之间的间距
        legend.setYOffset(0f);                       //设置比例块 Y 轴偏移量
        legend.setXOffset(0f);                    //设置比例块 X 轴偏移量
        legend.setTextColor(Color.WHITE);                //图例文字的颜色
        legend.setTextSize(10f);                  //设置图例标签文本的大小
